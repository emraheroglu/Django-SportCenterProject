...
class ContactFormu(ModelForm):
    class Meta:
        ...
        widgets = {
            'message': Textarea(attrs={'class': 'comment-form-comment', 'placeholder': 'Enter Message','rows':'5'}),
             'name': TextInput(attrs={'class': 'comment-form-author', 'placeholder': 'Enter your name'}),
             'email': TextInput(attrs={'class': 'comment-form-email', 'placeholder': 'Enter Email'}),
            'subject': TextInput(attrs={'class': 'comment-form-url', 'placeholder': 'Enter Subject'}),
        }
